...
5. Do inference with your network
   ...
   ```
6. how to change tacotron to adapt this waveglow
diff:
preemphasize=False
rescale=False
trim_slience=False
...
change todb
ref_level_db: 20 -> 0
signal_normalization: True -> False
...
===
preemphsize
librosa.stft, mag -- same
tomel(sr, fmin, fmax)
todb(clipmin-5, log10, *20)
minusref
shiftednormalization(-4,4)

-----------------
waveglow:
divide MAX
===
tacotron2/stft, mag -- same
tomel
todb(clipmin-5, log)
